package umc.meme.member.domain.artist.service;
...
import umc.meme.member.domain.artist.dto.response.ArtistDto;
...
import umc.meme.member.domain.artist.repository.AvailableTimeRepository;
