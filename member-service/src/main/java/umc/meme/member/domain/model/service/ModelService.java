package umc.meme.member.domain.model.service;
...
import umc.meme.member.domain.artist.dto.response.SimpleArtistDto;
import umc.meme.member.domain.artist.entity.Artist;
import umc.meme.member.domain.artist.repository.ArtistRepository;
import umc.meme.member.domain.favorite.dto.request.FavoriteArtistDto;
import umc.meme.member.domain.favorite.dto.request.FavoritePortfolioDto;
import umc.meme.member.domain.favorite.dto.response.FavoriteArtistPageResponseDto;
import umc.meme.member.domain.favorite.dto.response.FavoritePortfolioResponsePageDto;
...
import umc.meme.member.domain.favorite.repository.FavoritePortfolioRepository;
